                ...
                else
                {
                    ...
                    switch (key)
                    {
                        case "0":
                            ...
                            para.Add("url", App.DataOle777K8Ma.Urls.Register);
                        ...
                        case "1":
                            ...
                            para.Add("url", App.DataOle777K8Ma.Urls.Login);
                            NavigationService.NavigateAsync(nameof(WebviewPage), para);
                            break;

                        case "2":
                            para.Add("title", "Khuyến mãi");
                            para.Add("url", App.DataOle777K8Ma.Urls.Promotion);
                            NavigationService.NavigateAsync(nameof(WebviewPage), para);
                            break;

                        case "3":
                            para.Add("title", "Liên hệ CSKH");
                            para.Add("url", App.DataOle777K8Ma.Urls.Support);
                            NavigationService.NavigateAsync(nameof(WebviewPage), para);
                            break;

                        case "4":
                            para.Add("title", "Đối tác đại lý");
                            para.Add("url", App.DataOle777K8Ma.Urls.Afiliate);
                            NavigationService.NavigateAsync(nameof(WebviewPage), para);
                            break;
